...
class JsonUtl {
    ...
    private static final String LOG_TAG = JsonUtl.class.getSimpleName();
    ...
    public static List<Model> extractMovieData(String movieJson) {
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                Model movie = new Model(title, posterPath, releaseDate, voteAverage, description,id);
                movies.add(movie);
            }
    ...
    public static List<Model> fetchMovieAppData(String requestUrl) {
